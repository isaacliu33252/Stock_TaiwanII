...
| cash_constraint | `ok` | estimated_cash_after_rounding_before_cost=429,231 |
| execution_plan_pre_trade_guard | `ok` | pre_trade_guards=active_allowed |
...
| promotion_gate_deployment_summary | `warn` | deployment_summary_gate=fail, consistency=ok, blockers=['source_freshness_not_ok', 'ops_health_errors_present'] |
...
- Cash after cost: `429,231`
- Execution plan cash input: `0.0`
...
- Deployment summary blockers: `['source_freshness_not_ok', 'ops_health_errors_present']`
