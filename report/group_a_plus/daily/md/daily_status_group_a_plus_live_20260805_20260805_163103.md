...
| promotion_gate_deployment_summary | `warn` | deployment_summary_gate=fail, consistency=ok, blockers=['ops_health_errors_present'] |
...
- Deployment summary blockers: `['ops_health_errors_present']`
