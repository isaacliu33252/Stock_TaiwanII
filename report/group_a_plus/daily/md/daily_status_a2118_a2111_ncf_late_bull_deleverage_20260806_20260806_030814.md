...
| dfl_advisory_frozen_input_staleness | `warn` | frozen backtest last covers 2026-07-15 (22 calendar days behind check_date); matched_decision_count is structurally 0 until this is re-run |
...
- Leverage / hedge change count: `0` / `1`
- Normalized history available: `True`
- History entries / blocked: `114` / `73`
- History leverage / hedge interventions: `92` / `3`
