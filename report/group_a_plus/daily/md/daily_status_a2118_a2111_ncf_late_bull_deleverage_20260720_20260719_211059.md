...
| source_freshness | `block` | required strategy sources are stale or missing: ['institutional_0050']; soft strategy sources are stale or missing: ['securities_lending_0050']; NCF live overlay skipped: date mismatch {'00631L.TW': '2026-07-16', '00632R.TW': '2026-07-16'}, actual 2026-07-17; institutional_0050; securities_lending_0050 |
| cash_constraint | `ok` | estimated_cash_after_rounding_before_cost=300,082 |
...
- Daily OHLCV proxy state: `elevated` manual-review `True`
- Daily OHLCV proxy score: `0.21666666666666667` coverage `9`
- Proxy components volume/range/negative/limit: `0` / `3` / `4` / `1`
- 00631L add: `blocked`
- 00632R open: `blocked`
- OHLCV tickers / rows: `15` / `29641`
- Blocking reasons: `['china_2015_parameters_not_portable_to_group_a_plus', 'crash_warning_not_allowed_to_change_live_weights', 'five_day_systemic_failure_signal_not_validated_for_taiwan', 'missing_high_frequency_bid_ask', 'missing_intraday_minute_liquidity', 'missing_market_wide_failure_events', 'missing_stock_sector_style_mapping', 'nmi_illiquidity_network_not_implemented']`
...
- Usable tickers: `14`
- Components corr/edge/downside/concentration/TSMC: `0.676815` / `0.0` / `0.670426` / `None` / `0.173136`
- 00631L add: `blocked`
- 00632R open: `blocked`
...
- History entries / blocked: `40` / `21`
- History leverage / hedge interventions: `31` / `0`
...
- 00632R 30d mean/latest tracking error: `0.02914141424224918` / `0.0081190680562589`
- 00632R hedge beta/corr: `-0.9943236718895596` / `-0.9779260056912819`
...
- Golden1 STARR 95: `14.567266529463351`
- Golden1 Rachev 95/95: `1.034594033280388`
...
- Illiquidity daily proxy score: `0.21666666666666667`
- Illiquidity daily proxy state: `elevated`
