...
Generated: `2026-07-21T22:39:10`
Check date: `2026-07-21`
Overall: `block`
...
| execution_allowed | `block` | required strategy sources are stale or missing: ['day_trading_0050', 'foreign_shareholding_0050', 'short_balance_0050'] |
...
| source_freshness | `block` | required strategy sources are stale or missing: ['day_trading_0050', 'foreign_shareholding_0050', 'short_balance_0050']; soft strategy sources are stale or missing: ['securities_lending_0050']; foreign_shareholding_0050; short_balance_0050; day_trading_0050; securities_lending_0050 |
| cash_constraint | `ok` | estimated_cash_after_rounding_before_cost=300,078 |
| execution_plan_pre_trade_guard | `warn` | execution plan has no aligned pre_trade_guard |
| dfl_advisory_frozen_input_staleness | `ok` | frozen backtest last covers 2026-07-13 (8 calendar days behind check_date); matched_decision_count is structurally 0 until this is re-run |

## Signal

- Group A status: `hold_or_align_to_target`
- Reason: `A20.7 formal defensive state is inactive`
- Actual data date: `2026-07-21`
...
- AR1 5d / 20d: `-0.09381295550838877` / `-0.040391938512942004`
- Variance ratio: `0.37291836670718387`
- 00631L vs 0050 relative momentum: `-0.07674301337569822`
