...
Generated: `2026-08-04T03:36:55`
Check date: `2026-08-04`
Status stage: `final`
Overall: `block`
...
| cash_constraint | `ok` | estimated_cash_after_rounding_before_cost=429,241 |
| execution_plan_pre_trade_guard | `warn` | execution plan has no aligned pre_trade_guard |
| dfl_advisory_frozen_input_staleness | `warn` | frozen backtest last covers 2026-07-15 (20 calendar days behind check_date); matched_decision_count is structurally 0 until this is re-run |
...
- AR1 5d / 20d: `-0.029384080863104147` / `-0.022592760516756124`
- Variance ratio: `0.2419774491334117`
- 00631L vs 0050 relative momentum: `-0.10045685539708848`
...
- 2330/0050 corr 60d: `0.9017050837742865`
- ETF coupling score: `0.9572539357522407`
- Policy: `research_only_systemic_bubble_time_at_risk_no_weight_change`

## Illiquidity Network Readiness

- Status: `blocked`
- Actual data end: `2026-08-03`
...
- Daily OHLCV proxy score: `0.05555555555555555` coverage `9`
- Proxy components volume/range/negative/limit: `0` / `1` / `1` / `0`
- 00631L add: `blocked`
- 00632R open: `blocked`
- OHLCV tickers / rows: `15` / `30828`
...
- Actual data end: `2026-08-03`
- State: `normal`
- SIN-lite score: `0.349262`
- Manual review required: `False`
- Usable tickers: `14`
- Components corr/edge/downside/concentration/TSMC: `0.696298` / `0.0` / `0.64881` / `None` / `0.051941`
- 00631L add: `blocked`
- 00632R open: `blocked`
...
- 00631L Hill xi 95: `0.31831860527686245`
- 00631L POT-GPD xi 95: `0.07697812477654017`
- Turnover: `0.38078354815277643`
...
- History entries / blocked: `106` / `73`
- History leverage / hedge interventions: `91` / `0`
...
- 00631L 30d mean/latest tracking error: `-0.005076688928065661` / `-0.064605390709006`
- 00632R 30d mean/latest tracking error: `0.02891130243741187` / `0.00798832043133893`
- 00632R hedge beta/corr: `-0.9953038825989835` / `-0.9827460741949281`
...
- Golden1 STARR 95: `14.169038759099335`
...
- Illiquidity daily proxy score: `0.05555555555555555`
