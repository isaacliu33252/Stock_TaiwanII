...
Generated: `2026-08-05T16:30:46`
Check date: `2026-08-05`
...
| Check | Status | Detail |
| --- | --- | --- |
| live_signal_success | `block` | {'message': 'Unknown datetime string format, unable to parse: 2026--0-8-05', 'type': 'DateParseError', 'traceback': 'Traceback (most recent call last):\n  File "/mnt/c/Users/isaac/Downloads/Stock_taiwan2-main/Stock_taiwan2-main/group_a_plus/operations/daily_signal.py", line 1823, in main\n    signal = build_daily_signal(\n             ^^^^^^^^^^^^^^^^^^^\n  File "/mnt/c/Users/isaac/Downloads/Stock_taiwan2-main/Stock_taiwan2-main/group_a_plus/operations/daily_signal.py", line 1508, in build_daily_signal\n    as_of = pd.Timestamp(requested_as_of).normalize()\n            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "pandas/_libs/tslibs/timestamps.pyx", line 1865, in pandas._libs.tslibs.timestamps.Timestamp.__new__\n  File "pandas/_libs/tslibs/conversion.pyx", line 364, in pandas._libs.tslibs.conversion.convert_to_tsobject\n  File "pandas/_libs/tslibs/conversion.pyx", line 641, in pandas._libs.tslibs.conversion.convert_str_to_tsobject\n  File "pandas/_libs/tslibs/parsing.pyx", line 336, in pandas._libs.tslibs.parsing.parse_datetime_string\n  File "pandas/_libs/tslibs/parsing.pyx", line 666, in pandas._libs.tslibs.parsing.dateutil_parse\npandas._libs.tslibs.parsing.DateParseError: Unknown datetime string format, unable to parse: 2026--0-8-05\n'} |
| execution_allowed | `block` | blocked |
| data_freshness | `ok` | 0 business days stale, 0 calendar days stale |
| strategy_status | `block` | strategy_status=unknown, strategy_id=None |
| source_freshness | `ok` | all required sources ok |
| cash_constraint | `ok` | estimated_cash_after_rounding_before_cost=0 |
| execution_plan_pre_trade_guard | `warn` | execution plan has no aligned pre_trade_guard |
| dfl_advisory_frozen_input_staleness | `warn` | frozen backtest last covers 2026-07-15 (21 calendar days behind check_date); matched_decision_count is structurally 0 until this is re-run |
| daily_artifact_integrity | `block` | status=error, errors=1, warnings=0 |
| promotion_gate_deployment_summary | `warn` | deployment_summary_gate=fail, consistency=ok, blockers=['execution_plan_date_mismatch', 'ops_health_errors_present', 'gift_signed_approval_validator_smoke_failed'] |
...
- Profile: `group_a_plus_live`
- Overlay regime: `unknown`
...
- Status: `error`
- Errors: `['live_signal actual_data_date missing']`
- Warnings: `[]`
...
- Deployment summary blockers: `['execution_plan_date_mismatch', 'ops_health_errors_present', 'gift_signed_approval_validator_smoke_failed']`
...
- Trend score: `0`
- Mean-reversion score: `5`
- AR1 5d / 20d: `-0.46439138112324085` / `-0.02453316974155047`
- Variance ratio: `0.40760557162688715`
- 00631L vs 0050 relative momentum: `-0.05928972984427561`
...
- 00631L add: `blocked`
- Systemic score: `2`
- Time-at-risk / ETF coupling / reflexivity: `elevated` / `elevated` / `normal`
- 2330/0050 corr 60d: `0.9097801249722307`
- ETF coupling score: `0.9597273097984501`
- Policy: `research_only_systemic_bubble_time_at_risk_no_weight_change`

## Illiquidity Network Readiness

- Status: `blocked`
- Actual data end: `2026-08-05`
...
- Actual data end: `2026-08-05`
- State: `normal`
- SIN-lite score: `0.346905`
- Manual review required: `False`
- Usable tickers: `14`
- Components corr/edge/downside/concentration/TSMC: `0.701672` / `0.0` / `0.636804` / `None` / `0.049144`
- 00631L add: `blocked`
- 00632R open: `blocked`
...
- 00631L Hill xi 95: `0.3197802866295796`
- 00631L POT-GPD xi 95: `0.07151889364128078`
- Turnover: `0.8083768790577022`
...
- Nonzero trade count: `4`
- Leverage / hedge change count: `1` / `1`
- Normalized history available: `True`
- History entries / blocked: `112` / `73`
- History leverage / hedge interventions: `92` / `2`
...
- 00631L 30d mean/latest tracking error: `-0.005127147888962812` / `-0.04539915525307657`
- 00632R 30d mean/latest tracking error: `0.028863850024414002` / `-0.006196932738566908`
- 00632R hedge beta/corr: `-0.9914820020673626` / `-0.9820004745435117`
...
- Golden1 STARR 95: `14.58608808083165`
- Golden1 Rachev 95/95: `1.0953360658309348`
- 00631L Rachev 95/95: `1.0148925610933104`
