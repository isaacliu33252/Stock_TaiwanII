...
- Size-matched null: `False`
- Block permutation test: `False`
- Blocking reasons: `['size_matched_null_augmentation_missing', 'block_permutation_test_missing', 'walk_forward_oos_synthetic_validation_missing', 'directional_synthetic_alpha_default_blocked', 'finstressts_snapshot_blocked', 'hmm_wj_scenario_readiness_blocked', 'scenario_generator_not_decision_ready', 'dynamic_cvar_tail_cost_readiness_blocked', 'tail_cost_readiness_not_ready', 'density_tail_model_unstable_research_only', 'promotion_gate_blocked_multi_window']`
