...
- Existing GJR shadow status: `available` date=`2026-09-04` policy=`shadow_only_no_weight_change` evidence=`watch`
- GJR gamma: `0.314477` LR p-value=`0.000000`
- GJR/symmetric variance ratio: `0.839752` disagreement=`True` asymmetry_shock=`False`
