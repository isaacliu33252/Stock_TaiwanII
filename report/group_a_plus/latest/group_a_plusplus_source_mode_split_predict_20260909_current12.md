# GroupA++ Source Mode Split Predict 2026-09-09

- generated_at: `2026-09-07T13:32:09`
...
- `golden1_0531_frozen_pinned`: Keeps the pinned Golden1 signal; useful for version comparison, not a latest-data rerun. Path: `results/group_a_plusplus_golden1_0531_override_runner_20260909_current12.json`
- `golden1_0531_latestdata_rerun`: Regenerated from latest available data; expected to match latest base line when the same Golden1/last PPO mainline is used. Path: `results/group_a_plusplus_golden1_0531_override_runner_latestdata_20260909_current12.json`
- `golden2_0830_frozen_pinned`: Keeps the frozen 2026-08-28 Golden2 signal; preserves the historical 00632R leg. Path: `results/golden2_0830/group_a_plusplus_golden2_0830_override_runner_20260909_current12.json`
- `golden2_0830_latestdata_rerun`: Regenerated from latest data. Current frozen Golden2 model/result artifact is byte-identical to Golden1/last PPO, so it converges. Path: `results/golden2_0830/group_a_plusplus_golden2_0830_override_runner_latestdata_20260909_current12.json`
- `latest_groupA++`: Order source. Path: `results/group_a_plusplus_live_signal_v2_predict_20260909_from_20260904_total1000000_latest_strategy_current12.json`
