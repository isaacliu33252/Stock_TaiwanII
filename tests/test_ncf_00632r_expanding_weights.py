...
def _load_ncf_00632r_module():
    root = Path(__file__).resolve().parents[1]
    path = root / "ncf_00632r.py"
    spec = importlib.util.spec_from_file_location("_test_ncf_00632r", path)
...
def test_expanding_horizon_panel_does_not_rewrite_prior_rows() -> None:
    module = _load_ncf_00632r_module()
...
def test_expanding_horizon_panel_embargoes_unresolved_forward_labels() -> None:
    ...
    the fix, ncf_00632r.py's own copy of this function (never patched alongside
