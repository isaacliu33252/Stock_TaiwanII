...
from scripts.evaluate.build_group_a_plus_adversarial_market_integrity_review import write_review


def test_write_review_writes_latest_and_history_snapshot(tmp_path: Path) -> None:
    output = tmp_path / "latest" / "adversarial_market_integrity_review.json"
