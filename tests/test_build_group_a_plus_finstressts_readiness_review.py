...
from scripts.evaluate.build_group_a_plus_finstressts_readiness_review import write_review


def test_write_review_writes_latest_and_history_snapshot(tmp_path: Path) -> None:
    output = tmp_path / "latest" / "finstressts_readiness_review.json"
    ...
    review = {
        ...
        "status": "blocked",
        "as_of": "2026-07-20",
        "blocking_reasons": ["mechanism_stress_coverage_blocked"],
    }
