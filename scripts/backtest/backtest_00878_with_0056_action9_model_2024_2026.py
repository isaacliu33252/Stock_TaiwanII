#!/usr/bin/env python3
"""Backtest 00878.TW on 2024-2026 using the existing 0056.TW action-9 model."""
...
def main() -> None:
    ...
    output_file = (
        PROJECT_ROOT
        / "results"
        / f"backtest_00878_with_0056_action9_model_2024_2026_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
