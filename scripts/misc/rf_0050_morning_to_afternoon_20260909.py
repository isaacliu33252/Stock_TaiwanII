...
0050.TW using features built from the 9:00-12:00 morning session, inspired
...
Data source: yfinance 30-minute bars for 0050.TW. Yahoo's own API limits
...
def fetch_data() -> pd.DataFrame:
    df = yf.download("0050.TW", period="60d", interval="30m", progress=False)
...
def main() -> None:
    print("Fetching 0050.TW 30-minute bars (max ~60 days via yfinance)...")
    raw = fetch_data()
    ...
    out_path = PROJECT_ROOT / "results" / "rf_0050_lasthour_20260909.csv"
    test_out = test.copy()
