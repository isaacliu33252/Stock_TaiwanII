#!/usr/bin/env python3
"""Train 0056.TW from scratch on 2016-2023 and backtest on 2024-2026."""
...
from portfolio_config import LEARNING_RATE, PORTFOLIO_HOLDINGS
from portfolio_data_loader import download_all_stocks
from safe_ppo import GradientClipCallback, SafeActorCriticPolicy
...
def main() -> None:
    print("=" * 72)
    print("0056.TW retrain from scratch")
    ...
    output_file = (
        PROJECT_ROOT
        / "results"
        / f"retrain_0056_40000_200k_backtest_2024_2026_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
