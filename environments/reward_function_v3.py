...
5. Benchmark-relative Reward（相對報酬）：
   - 鼓勵模型跑贏大盤，避免「有買有保庇」的無效策略

6. MA Trend Following（均線趨勢追蹤）：
   - MA5 > MA20 → 多頭格局 → 持倉 bonus，空手 penalty
   - MA5 < MA20 → 空頭格局 → 空手 bonus，持倉 penalty
...
class DynamicRewardShaper:
    ...
    def calculate(
        ...
        # =================================================================
        # 1. 資本報酬 (核心獎勵) + Benchmark-relative 報酬
        # =================================================================
        ...
        # =================================================================
        # 4. 持有獎勵（核心問題修復：平原/小虧也要獎勵，不能只靠 unrealized_pnl）
        # =================================================================
        rewards['holding'] = 0.0
